...
export const STRINGS = {
  en: {
    ...
    coverage_title: 'Areas we cover',
    coverage_help: 'Tap an area to add or remove it from what your crew answers for on this service.',
    geography_title: 'All areas in this service',
  ...
  hi: {
    ...
    coverage_title: 'हमारे इलाके',
    coverage_help: 'इस सेवा में आपकी टीम जिन इलाकों की ज़िम्मेदारी लेती है — जोड़ने या हटाने के लिए दबाइए।',
    geography_title: 'इस सेवा के सारे इलाके',
